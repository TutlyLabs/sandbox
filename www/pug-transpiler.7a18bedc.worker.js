...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../node_modules/thread-loader/dist/cjs.js?!../../node_modules/babel-loader/lib/index.js?!./src/sandbox/eval/transpilers/pug/pug-worker.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../node_modules/thread-loader/dist/cjs.js?!../../node_modules/babel-loader/lib/index.js?!./src/sandbox/eval/transpilers/pug/pug-worker.ts":
...
// CONCATENATED MODULE: /Users/uday/Desktop/projects/codesandbox-client/node_modules/thread-loader/dist/cjs.js??ref--9-0!/Users/uday/Desktop/projects/codesandbox-client/node_modules/babel-loader/lib??ref--9-1!./src/sandbox/eval/transpilers/pug/pug-worker.ts
self.importScripts("".concat("/sandpack"||false,"/static/js/browserified-pug.0.1.0.min.js"));const childHandler=new child_handler_ChildHandler('pug-worker');function workerCompile(_x){return _workerCompile.apply(this,arguments);}function _workerCompile(){_workerCompile=asyncToGenerator_default()(function*(opts){const code=opts.code,path=opts.path;// register a custom importer callback
const transpiledCode=yield new Promise((resolve,reject)=>{// @ts-ignore
self.pug.render(code,{filename:path},(err,html)=>{if(err){return reject(err);}return resolve(html);});});return{transpiledCode};});return _workerCompile.apply(this,arguments);}childHandler.registerFunction('compile',workerCompile);childHandler.emitReady();

/***/ })

/******/ });
//# sourceMappingURL=pug-transpiler.7a18bedc.worker.js.map