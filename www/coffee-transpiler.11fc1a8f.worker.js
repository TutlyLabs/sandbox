...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../node_modules/thread-loader/dist/cjs.js?!../../node_modules/babel-loader/lib/index.js?!./src/sandbox/eval/transpilers/coffee/coffee-worker.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../node_modules/thread-loader/dist/cjs.js?!../../node_modules/babel-loader/lib/index.js?!./src/sandbox/eval/transpilers/coffee/coffee-worker.ts":
...
// CONCATENATED MODULE: /Users/uday/Desktop/projects/codesandbox-client/node_modules/thread-loader/dist/cjs.js??ref--9-0!/Users/uday/Desktop/projects/codesandbox-client/node_modules/babel-loader/lib??ref--9-1!./src/sandbox/eval/transpilers/coffee/coffee-worker.ts
const childHandler=new child_handler_ChildHandler('coffee-worker');self.importScripts("".concat("/sandpack"||false,"/static/js/coffeescript.2.3.2.js"));function workerCompile(_x){return _workerCompile.apply(this,arguments);}function _workerCompile(){_workerCompile=asyncToGenerator_default()(function*(opts){const code=opts.code,path=opts.path;// @ts-ignore
const compiled=self.CoffeeScript.compile(code,{filename:path,sourceFiles:[path],bare:true,literate:false,inlineMap:true,sourceMap:false});return{code:compiled};});return _workerCompile.apply(this,arguments);}childHandler.registerFunction('compile',workerCompile);childHandler.emitReady();

/***/ })

/******/ });
//# sourceMappingURL=coffee-transpiler.11fc1a8f.worker.js.map