...
import LinterWorker from 'worker-loader?name=monaco-linter.[hash:8].worker.js!app/overmind/effects/vscode/LinterWorker';
import TypingsFetcherWorker from 'worker-loader?name=monaco-typings-ata.[hash:8].worker.js!./workers/fetch-dependency-typings';
